# Contributing to gCBS

First off, thanks for taking the time to contribute!
We are so happy to have you! :tada:

There are opportunities to contribute to gCBS at any level.
It doesn't matter if you are just getting started with Web/App Technologies or are the most
...
The GCBS project adheres to the [Contributor-Convenant][cc].
...
1. By opening the issue for discussion: For instance, if you believe that you
   have discovered a bug in GCBS, creating a new issue in [the
   p-society/gCBS issue tracker][issue] is the way to report it.
...
3. By helping to resolve the issue: Typically this is done either in the form of
   ...
   GCBS in a concrete and reviewable manner.

[issue]: https://github.com/p-society/p-society/gCBS
...
When opening a new issue in the gCBS issue tracker, you will be presented
...
functional guidelines of the gCBS project.

## Pull Requests

Pull Requests are the way concrete changes are made to the code, documentation,
and dependencies in the gCBS repository.
...
`<scope>` should be the name of the API affected (as perceived by the person
...
1. ```text
   feat(basketball-api): add support for winrate.
...
**Any gCBS community member is welcome to review any pull request**.

All gCBS contributors who choose to review and provide feedback on Pull
...
1. Does this change make sense for gCBS?
2. Does this change make gCBS better, even if only incrementally?
...
Most nits can typically be fixed by the gCBS collaborator landing the
...
Yes, we may land a particular change that makes gCBS better, but the
individual might just not want to have anything to do with gCBS ever
again.
...
The gCBS GitHub repository has a lot of issues and PRs to keep track of.
